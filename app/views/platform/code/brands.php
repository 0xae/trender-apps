    ...
    <div>
        <div class="by bz ca" style="width:50px;float: left; margin-right: 5px;">
            <a class="cb" 
               ...
               title="Profile picture of {{post.author.title}}">
...
<!--
<div class="dg di ds">
<h3 class="dt dm" style="">
    <span>
        <strong> <a href="javascript:void(0)">Most liked posts</a> </strong>
    </span>
</h3>
</div>
-->

<div class="dg di ds" style="margin-bottom: 5px">
<h3 class="dt dm" style="">
    <span>
        <strong> <a href="javascript:void(0)">Brands here</a> </strong>
    </span>
</h3>
</div>

<div style="padding:12px;margin:0px;padding-top:8px;" id="brands_container">
</div>
